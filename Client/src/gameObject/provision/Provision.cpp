...
Provision::Provision(int x, int y, const TypeEffect &typeEffect, const TypeContact &typeContact) :
                    GameObject(LoaderParams(x, y, 27, 32, "box")), m_typeEffect(typeEffect),
                    m_typeContact(typeContact) {}
