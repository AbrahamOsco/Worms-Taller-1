...
Engine::Engine(std::vector<Beam> &beams, Water &water, const std::string &background, Queue<std::unique_ptr<Command>> &bQueue,
...
void Engine::render() {
    m_renderer.Clear();
    m_textureManager.draw(m_background, 0, 0, 1920, 1080, m_renderer, SDL_FLIP_NONE);
    m_water.draw(m_renderer,m_textureManager);
