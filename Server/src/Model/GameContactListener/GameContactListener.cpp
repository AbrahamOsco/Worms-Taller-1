...
void projectileBazookaCollidesWithWorm(GameObject* projectileBazooka,
                GameObject* worm, GameParameters *gameParameters) {
    std::cout << "projectileBazookaCollidesWithWorm\n";
    if (projectileBazooka == nullptr || worm == nullptr) return;
...
void wormCollidesWithProjectileBazooka(GameObject* worm1, GameObject* projectileBazooka,
...
void projectileBazookaCollidesWithEdge(GameObject* projectileBazooka,
...
void edgeCollidesWithProjectileBazooka(GameObject* edge,
        GameObject* projectileBazooka, GameParameters *gameParameters) {
    std::cout << "edgeCollidesWithProjectileBazooka\n";
    projectileBazookaCollidesWithEdge(projectileBazooka, edge, gameParameters);
}

void projectileBazookaCollidesWithWater(GameObject* projectileBazooka,
            GameObject* water, GameParameters *gameParameters) {
    std::cout << "projectileBazookaCollidesWithWater\n";
    projectileBazooka->destroyBody();
}

void waterCollidesWithProjectileBazooka(GameObject* water,
        GameObject* projectileBazooka, GameParameters *gameParameters) {
...
void provisionCollideWithProjectileBazooka(GameObject* provision,
        GameObject* projectileBazooka, GameParameters *gameParameters) {
...
void projectileBazookaCollidesWithProvision(GameObject* projectileBazooka,
        GameObject* provision, GameParameters *gameParameters) {
...
void edgeCollidesWithAirAttackMissile(GameObject* edge,
    GameObject* airAttackMissile, GameParameters *gameParameters) {
...
void waterCollidesWithAirAttackMissile(GameObject* water,
    GameObject* airAttackMissile, GameParameters *gameParameters) {
...
void airAttackMissileCollidesWithProvision(GameObject* airAttackMissile,
    GameObject* provision, GameParameters *gameParameters) {
...
void provisionCollideWithAirAttackMissile(GameObject* provision,
    GameObject* airAttackMissile, GameParameters *gameParameters) {
...
void airAttackMissileCollidesWithWorm(GameObject* airAttackMissile,
    GameObject* worm, GameParameters *gameParameters) {
...
void wormCollidesWithAirAttackMissile(GameObject* worm,
    GameObject* airAttackMissile, GameParameters *gameParameters) {
    std::cout << "wormCollidesWithAirAttackMissile\n";
    airAttackMissileCollidesWithWorm(airAttackMissile, worm, gameParameters);
}

void airAttackMissileCollideWithBeam(GameObject* airAttackMissile,
    GameObject* beam, GameParameters *gameParameters) {
...
void beamCollidesWithAirAttackMissile(GameObject* beam,
    GameObject* airAttackMissile, GameParameters *gameParameters) {
    std::cout << "beamCollidesWithAirAttackMissile\n";
    airAttackMissileCollideWithBeam(airAttackMissile, beam, gameParameters);
}

void airAttackMissileCollidesWithAirAttackMissile(GameObject* airAttackMissile,
    GameObject* airAttackMissil2,  GameParameters *gameParameters) {
...
void dynamiteCollidesWithProvision(GameObject* dynamite,
    GameObject* provision, GameParameters *gameParameters) {
    std::cout << "dynamiteCollidesWithProvision\n";
}

void provisionCollideWithDynamite(GameObject* provision,
    GameObject* dynamite, GameParameters *gameParameters) {
...
void mortarProjCollidesWithProvision(GameObject* mortarProj,
    GameObject* provision, GameParameters *gameParameters) {
...
void provisionCollideWithMortarProj(GameObject* provision,
    GameObject* mortarProj, GameParameters *gameParameters) {
...
void mortarProjCollideWithMortarProj(GameObject* mortarProj1,
    GameObject* mortarProj2, GameParameters *gameParameters) {
    std::cout << "beamCollidesWithMortarProj\n";
...
GameContactListener::GameContactListener(b2World *world, GameParameters *gameParameters) {
    ...
    collisionsMap[std::make_pair(ENTITY_BAZOOKA_PROJECTILE, ENTITY_PROVISION)] =
            &projectileBazookaCollidesWithProvision;
    ...
    collisionsMap[std::make_pair(ENTITY_AIR_ATTACK_MISSILE, ENTITY_AIR_ATTACK_MISSILE)] =
            &airAttackMissileCollidesWithAirAttackMissile;
