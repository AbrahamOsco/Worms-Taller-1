...
Worm::Worm(const Posicion &unaPos, const float &unaVelocidad, const float &unaAltura, const float &unHp) : posActual(unaPos),
                                                                                                           velocidad(unaVelocidad), alturaSalto(unaAltura), hp(unHp) {

}

void Worm::moverse(const Direccion &unaDireccion) {
